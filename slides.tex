\documentclass[12pt,aspectratio=169,english,pdflatex%,handout
]{beamer}
...
\usepackage[maxbibnames=99,citestyle=authoryear,bibstyle=authoryear,sorting=nyt,natbib=true,backend=bibtex]{biblatex}
\renewcommand\nameyeardelim{, }
...
\addbibresource{science_combined.bib}
...
\frame{\titlepage
  \centering
  \includegraphics[height=3cm]{lab-photos/Augustana-mics.jpg}
  \includegraphics[height=3cm]{lab-photos/rothenberg-in-use.png}
  \includegraphics[height=3cm]{Pertti_sedan_letkuradio.jpg}
  \includegraphics[height=3cm]{lab-photos/Augustana-plastic.png}
} 
...
\begin{columns}
  \begin{column}{.8\textwidth}
    \begin{itemize}
      \item {\bf Foundational skills:} Students learn, e.g., finding, critiquing,
      and {\em curating information} in the age of AI.
      \item {\bf Intentional learning:} Students learn to integrate {\em new
      methods} into their professional practice.
      ...
      for students to {\em learn in practice and think critically} about tongue
      ...
      \item {\bf Cross-disciplinary teaching:} I provide joint courses with
      other programs (University of Helsinki 2011-2012) to facilitate {\em
      learning collaboration} with physicians, occupational therapists,
      physical therapists, engineers, etc.
    \end{itemize}    
  \end{column}
  \begin{column}{.18\textwidth}
    \includegraphics[width=\columnwidth]{3D_a_e.jpg}
    \includegraphics[width=\columnwidth]{lab-photos/Augustana-consonants.png}
    \includegraphics[width=\columnwidth]{lab-photos/Augustana-praat.png}
  \end{column}
\end{columns}
...
\begin{columns}
  \begin{column}{.8\textwidth}
    ...
    users who are knowledgeable in articulation and anatomy. 
      \begin{itemize}
      \item {\bf Speech pathology:} I use ultrasound in studying stuttering,
      Parkinsons disease, and covert speech errors
      \citep{LloydEtAl-ImpactRealtimeArticulatory-2019}.
      \item {\bf Biofeedback:} Patients and clients quickly orient to their own
      articulation. 
    \end{itemize}
    \item {\bf Demonstration - two ways to look at stuttering:} 
      \begin{itemize}
      \item Ultrasound video of silent speech articulation in stuttering.
      \item PATKIT \citep{PaloEtAl-PATKITPhoneticAnalysis-2026} analysis of the same recording.
      \end{itemize}
    \end{itemize}
  \end{column}
  \begin{column}{.18\textwidth}
...
\frame{\frametitle{Ultrasound stuttering example}
  ...
  Video available on YouTube: \url{https://youtu.be/f76Ieuss040}
}

\frame{\frametitle{PATKIT example}
  \centering
  \includegraphics[width=.8\textwidth]{patkit-stuttering.png}
\note{   
...
\begin{columns}
  \begin{column}{.8\textwidth}
    ...
    \item {\bf Building community connections:} My skills will be useful in
...
\begin{columns}
  ...
  \begin{column}{.75\textwidth}
    \begin{enumerate}
      ...
      \textcite{Ladefoged-PhoneticDataAnalysis-2003} and
      \textcite{RebernikEtAl-SPRAAKLABMobileLaboratory-2025}, I will bring speech
