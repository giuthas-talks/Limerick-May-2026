...
\begin{itemize}
  \item I focus on foundational skills such as finding, critiquing, and curating
  information.
  \item I teach students how to learn with intention in general and especially
  how to efficiently learn and integrate new methods into their professional
  practice.
  \item I do not just tell of new tools, but I build the spaces and open source
  software
  ...
  \item I want to provide joint courses with other programs to teach students
  practical collaboration with other professionals such as physicians,
  occupational therapists, physical therapists, and even engineers (University
  of Helsinki 2011-2012).
\end{itemize}
...
\frame{\frametitle{Priority 2: Accessible clinical tools}
  ...
  \item It is useful in studying pathologies such as stuttering, Parkinsons
  disease, or covert errors \citep{LloydEtAl-ImpactRealtimeArticulatory-2019},
  and it is an effective way of providing biofeedback. 
  \item Example of speech analysis with PATKIT \citep{PaloEtAl-PATKITPhoneticAnalysis-2026}.
...
\frame{\frametitle{Priority 3: Serving the entire population}
  ...
  responsible use of existing languages in fictional settings (Ropecons 2022-2025). 
  ...
  just some fraction of it \citep{LonnqvistEtAl-HowYoungAdults-2017}. 
  \item In Ireland I can see that my skills in community connection building
  can be useful in working with for example the The Gaeltacht, the Traveller
  community and migrant populations. 
  \end{itemize}
...
\frame{\frametitle{Concrete action on the priorities}

\begin{enumerate}
  \item With university and grant funding, I want to setup a world class
  teaching laboratory at University of Limerick. With my experience of
  designing and building such facilities (University of Helsinki 2020,
  University of Alberta 2024-2026), I can design it to fit in limited space or
  even make it possible to set the lab up for a class and quickly pack it away
  after.
  \item I am planning an international project to study articulatory stability
  in Parkinsons with ultrasound. Given Canada's recent joining of EU research
  programs, this will be a major EU grant with collaborators from Canada and
  Finland on this topic with methods I have developed over the past decade
  ...
  \item To bring speech research and therapy to the whole population, I plan to
  take the idea of the mobile lab/clinic in a van idea from the Netherlands
  \citep{RebernikEtAl-SPRAAKLABMobileLaboratory-2025} and build a version
  adapted to the Irish conditions and needs as a major grant funded project.
\end{enumerate}
