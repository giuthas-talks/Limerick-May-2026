...
\centering
\includegraphics[height=.6\textheight]{infographic.png}
...
\begin{columns}
  \begin{column}{.8\textwidth}
    ...
    \item {\bf Connection skills:} For last two years I have been building
    relationships with Indigenous communities in and around Edmonton.
