...
\begin{enumerate}
  ...
  after.
  \item I am planning an international project to study Parkinsons with
  ultrasound. Given Canada's recent joining of EU research programs, this will
  be a major EU grant with collaborators from Canada and Finland on this topic
  with methods I have developed over the past decade
  ...
  take the idea of the mobile lab/clinic idea from the Netherlands
  \citep{RebernikEtAl-SPRAAKLABMobileLaboratory-2025} and adapt it to the Irish
  conditions and needs as a major grant funded project.
\end{enumerate}
